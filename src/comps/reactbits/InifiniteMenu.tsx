        ...
        <>
          ...
          <h2
            className={`
              ...
              absolute
              font-black
              text-4xl sm:text-5xl md:text-[4rem]
              left-4 md:left-[1.6em]
              top-1/2
              transform
          ...
          <p
            className={`
              ...
              ${
                isMoving
                  ? "opacity-0 pointer-events-none duration-[100ms] translate-x-0 md:translate-x-[-60%] -translate-y-1/2"
              ...
              className={`
                ...
                ${
                  isMoving
                    ...
                    : "bottom-[3.5em] opacity-100 pointer-events-auto duration-[500ms] scale-100 -translate-x-1/2"
                }
              `}
            >
              <p className="select-none relative text-[#060010] top-[1px] text-[22px] sm:text-[26px]">
                &#x2197;
              </p>
            </div>
          </Link>
